// Wyborca maksymalizujący jednocechowy.
public class MaxTraitVoter extends NonInfluencableVoter
{
    // Cecha wg. której wybiera wyborca.
    private int whichTrait;

    public MaxTraitVoter(String name, String surname, int favParty, int whichTrait, int district)
    {
